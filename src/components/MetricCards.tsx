...
export const MetricCards: React.FC<MetricCardsProps> = ({
  ...
  return (
    <div id="metric-cards-row" dir="rtl" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
      {cards.map((card) => {
        ...
        return (
          <div
            ...
            className={`cursor-pointer group flex flex-col justify-between p-4.5 rounded-2.5xl transition-all relative overflow-hidden h-[138px] select-none ${
              isAccent
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <span className={`text-[12.5px] font-extrabold tracking-wide ${
            ...
            <div className="flex items-center gap-2 mt-auto">
              {card.badge ? (
                <div className={`flex items-center gap-1 rounded-md px-1.5 py-0.5 text-[9px] font-extrabold tracking-wide ${
                  isAccent 
